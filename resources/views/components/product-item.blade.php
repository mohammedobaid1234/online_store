        <div class="ps-shoe mb-30">
            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="{{ asset('assets/front/#')}}"><i class="ps-icon-heart"></i></a><img src="{{ asset('assets/front/images/shoe/2.jpg')}}" alt=""><a class="ps-shoe__overlay" href="{{ asset('assets/front/product-detail.html')}}"></a>
            </div>
