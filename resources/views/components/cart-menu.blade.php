<div class="ps-cart"><a class="ps-cart__toggle" href="{{ route('carts.index')}}"><span><i id="cart_quantity">{{$cart->quantity()}}</i></span><i class="ps-icon-shopping-cart"></i></a>
    <div class="ps-cart__listing">

      <div class="ps-cart__content">
          @foreach ($cart->all() as $item)
            <div class="ps-cart-item"><a class="ps-cart-item__close" href="{{route('home.show',['slug'=> $item->product->slug])}}"></a>
      ...
      <div class="ps-cart__footer"><a class="ps-btn" href="{{route('checkout.create')}}">Check out<i class="ps-icon-arrow-left"></i></a></div>
    </div>
  </div>